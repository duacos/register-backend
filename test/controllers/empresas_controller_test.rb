...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { description: @empresa.description, name: @empresa.name } }, as: :json
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { description: @empresa.description, name: @empresa.name } }, as: :json
    assert_response 200
  end
